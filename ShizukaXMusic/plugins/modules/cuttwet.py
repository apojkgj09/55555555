...
@app.on_message(filters.command(["تويت","كت"],""))
...
iddof = []
@app.on_message(filters.command(["قفل الكت"],""))
async def iddlock(client, message):
   ...
   if get.status in ["creator", "administrator"]:
      ...
      return await message.reply_text("لازم تكون ادمن لاستخدام هذا الامر")

@app.on_message(filters.command(["فتح الكت"],""))
async def iddopen(client, message):
   ...
   if get.status in ["creator", "administrator"]:
      ...
      return await message.reply_text("لازم تكون ادمن لاستخدام هذا الأمر")
