    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**معليش حبي المحادثة الصوتية مقفلة افتح المحادثةالصوتية أولا وستمتع."
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                "**- معليش حبي بس المكالمة مقفلة !**- اذا كانت مفتوحه قفلها وارجع افتحها واذا طلعت هذي الرسالة اكثر من مرة ارسل امر  /restart."
            )
